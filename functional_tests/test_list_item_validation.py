...
class ItemValidationTest(FunctionalTest):
    ...
    def test_cannot_add_empty_list_items(self):
        ...
        error = self.get_error_element() # Bootstrap class
    ...
    def test_cannot_add_duplicate_items(self):
        ...
        # She accidentally tries to endter a duplicate item
        self.get_item_input_box(). send_keys('Buy wellies\n')
    ...
    def test_error_messages_are_cleared_on_click(self):
        ...
        # She clicks in the input box, preparing to enter text
        self.get_item_input_box().click()

        # She is pleased to see the error message disappears immediately
        error = self.get_error_element()
